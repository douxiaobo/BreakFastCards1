<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="BreakfastCards1.index" %>
...
<head runat="server">
    ...
    <title>Breakfast Card Manage System</title>
...
<body>
        ...
        <nav class="navbar navbar-dropdown navbar-expand-lg">
            <div class="container">
                <div class="navbar-brand">
                    ...
                    <span class="navbar-caption-wrap"><a class="navbar-caption text-primary display-5" href="https://mobiri.se">Breakfast Card Manage System</a></span>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                        ...
                        <li class="nav-item"><a class="nav-link link text-primary display-7" href="index.html#features16-9">About</a></li>
                    </ul>
                    ...
                    <div class="navbar-buttons mbr-section-btn">
                        <a class="btn btn-primary display-4" href="https://mobiri.se">Shop Now</a>
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                        <strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla aliquam a nibh ut consectetur. Vestibulum nec massa a nisl condimentum mattis. Mauris semper risus dui, vitae pulvinar sapien rutrum in.</strong>
                    </p>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="card col-12 col-lg-6">
                    <div class="card-wrapper mbr-flex">
                        <div class="card-box align-left">
                            ...
                            <h5 class="card-title mbr-fonts-style align-left mb-3 display-5"><strong>Registration</strong></h5>
                            <p class="mbr-text mbr-fonts-style mb-3 display-4">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla aliquam a nibh ut consectetur. Vestibulum nec massa.
                            </p>
                            <div class="mbr-section-btn"><a href="https://localhost:44340/WebForm_AARegistration.aspx" class="btn btn-secondary display-4">Registration</a></div>
                        </div>
                ...
                <div class="card col-12 col-lg-6">
                    <div class="card-wrapper mbr-flex">
                        <div class="card-box align-left">
                            <h6 class="card-subtitle mbr-fonts-style align-left mb-2 display-4">Collection</h6>
                            <h5 class="card-title mbr-fonts-style align-left mb-3 display-5"><strong>Rare Plants</strong></h5>
                            <p class="mbr-text mbr-fonts-style mb-3 display-4">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla aliquam a nibh ut consectetur. Vestibulum nec massa.
                            </p>
                            <div class="mbr-section-btn"><a href="https://localhost:44340/WebForm_AARecord.aspx" class="btn btn-secondary display-4">Collection</a></div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md">
                            <div class="card-box">
                                <div class="row">
                                    <div class="col-md">
                                        <h6 class="card-title mbr-fonts-style display-2"><strong>Breakfast Cards Manage System&nbsp;</strong></h6>
                                        <p class="mbr-text mbr-fonts-style display-7">
                                            Registration<br>
                                                
                                                    <div>
                                                        Year:<asp:DropDownList ID="DropDownList_Add_Year_Registration" runat="server"></asp:DropDownList>
                                                        Month:<asp:DropDownList ID="DropDownList_Add_Month_Registration" runat="server" AutoPostBack="false"></asp:DropDownList>
                                                        Group Name:<asp:DropDownList ID="DropDownList_Add_GroupName_Registration" runat="server" AutoPostBack="false"></asp:DropDownList>
                                                        Quantity:<asp:TextBox ID="TextBox_Add_Quantity_Registration" runat="server" Width="60px"></asp:TextBox>
                                                        <asp:Button ID="Button__Registration" runat="server" Text="Add" />
                                                    </div>
                                                    <div>
                                                        <asp:GridView ID="GridView_Registration" runat="server"></asp:GridView>
                                                    </div>
                                    ...
                                    <div class="col-md-auto">
                                        ...
                                        <div class="mbr-section-btn">
                                            <a href="https://mobiri.se" class="btn btn-secondary display-4">Buy Now
                                            </a>
                                        </div>
                                    </div>
                                    <div></div>
                        ...
                        <div class="col-12 col-md">
                            <div class="card-box">
                                <div class="row">
                                    <div class="col-md">
                                        <h6 class="card-title mbr-fonts-style display-2"><strong>Breakfast Cards Manage System</strong></h6>
                                        <p class="mbr-text mbr-fonts-style display-7">Collection </p>
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            card 
            <asp:Button ID="Button_FullAttendance_Collection" runat="server" Text="Full Attendance" OnClick="Button_FullAttendance_Collection_Click"  />
                                            <asp:Button ID="Button_LostCard_Collection" runat="server" Text="Lost Card" OnClick="Button_LostCard_Collection_Click" />
                                            
                                            <br />
                                            <asp:CheckBoxList ID="CheckBoxList_Add_Collection" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                            </asp:CheckBoxList>
                                            <asp:Button ID="Button_Add_Collection" runat="server" Text="Add" OnClick="Button_Add_Collection_Click" ></asp:Button>
                                        </div>
                                        <asp:GridView ID="GridView_Collection" runat="server"></asp:GridView>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md">
                            <div class="card-box">
                                <div class="row">
                                    <div class="col-md">
                                        <h6 class="card-title mbr-fonts-style display-2"><strong>Headset Manage System</strong></h6>
                                        <p class="mbr-text mbr-fonts-style display-7">
                                            耳机管理系统<br>
                                        </p>
                                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg">
                        <div class="text-wrapper">
                            <h6 class="card-title mbr-fonts-style display-2"><strong>About Breakfast Cards Manage System</strong></h6>
                            <p class="mbr-text mbr-fonts-style mb-4 display-4">
                                The Breakfast Cards Manage System for Model Work Group.&nbsp;<br>
                                <br>
                                Help FTE for learning Breackfast Cards information.&nbsp;
                            </p>
                ...
                <div class="card col-12 col-md-6 col-lg-4">
                    <div class="card-wrapper">
                        ...
                        <div class="card-box align-center">
                            ...
                            <p class="mbr-text mbr-fonts-style mb-4 display-4">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla aliquam a nibh ut consectetur.
                            </p>
                ...
                <div class="item features-image сol-12 col-md-6 col-lg-4">
                    <div class="item-wrapper">
                        ...
                        <div class="mbr-section-btn item-footer mt-2">
                            <a href="" class="btn item-btn btn-primary display-4" target="_blank">Read More
                            &gt;</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row mbr-gallery mt-4">
                <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#tl5pjsE6sJ-modal" data-bs-target="#tl5pjsE6sJ-modal">
                        <img class="w-100" src="assets/images/mbr.jpg" alt="Mobirise Website Builder" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-tl5pjsE6sJ" data-bs-target="#lb-tl5pjsE6sJ">
                ...
                <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#tl5pjsE6sJ-modal" data-bs-target="#tl5pjsE6sJ-modal">
                        <img class="w-100" src="assets/images/mbr-5.jpg" alt="Mobirise Website Builder" data-slide-to="1" data-bs-slide-to="1" data-target="#lb-tl5pjsE6sJ" data-bs-target="#lb-tl5pjsE6sJ">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#tl5pjsE6sJ-modal" data-bs-target="#tl5pjsE6sJ-modal">
                        <img class="w-100" src="assets/images/mbr-1.jpeg" alt="Mobirise Website Builder" data-slide-to="2" data-bs-slide-to="2" data-target="#lb-tl5pjsE6sJ" data-bs-target="#lb-tl5pjsE6sJ">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#tl5pjsE6sJ-modal" data-bs-target="#tl5pjsE6sJ-modal">
                        <img class="w-100" src="assets/images/mbr-10.jpeg" alt="Mobirise Website Builder" data-slide-to="3" data-bs-slide-to="3" data-target="#lb-tl5pjsE6sJ" data-bs-target="#lb-tl5pjsE6sJ">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    </div>
            ...
            <div class="modal mbr-slider" tabindex="-1" role="dialog" aria-hidden="true" id="tl5pjsE6sJ-modal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="carousel slide" id="lb-tl5pjsE6sJ" data-interval="5000" data-bs-interval="5000">
                                ...
                                <ol class="carousel-indicators">
                                    <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#lb-tl5pjsE6sJ" data-bs-target="#lb-tl5pjsE6sJ"></li>
                                    <li data-slide-to="1" data-bs-slide-to="1" data-target="#lb-tl5pjsE6sJ" data-bs-target="#lb-tl5pjsE6sJ"></li>
                                    <li data-slide-to="2" data-bs-slide-to="2" data-target="#lb-tl5pjsE6sJ" data-bs-target="#lb-tl5pjsE6sJ"></li>
                                    <li data-slide-to="3" data-bs-slide-to="3" data-target="#lb-tl5pjsE6sJ" data-bs-target="#lb-tl5pjsE6sJ"></li>
                                </ol>
                                <a role="button" href="" class="close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Close"></a>
                                <a class="carousel-control-prev carousel-control" role="button" data-slide="prev" data-bs-slide="prev" href="#lb-tl5pjsE6sJ">
                                    <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
                                    <span class="sr-only visually-hidden">Previous</span>
                                </a>
                                <a class="carousel-control-next carousel-control" role="button" data-slide="next" data-bs-slide="next" href="#lb-tl5pjsE6sJ">
            ...
            <div class="row justify-content-center mt-4">
                ...
                <div class="map-wrapper col-12 col-md-6">
                    <div class="google-map">
                        <iframe frameborder="0" style="border: 0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCZI5F_k6S1k46ujh0SNrapM89f7mJxd30&amp;q=350 5th Ave, New York, NY 10118" allowfullscreen=""></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="display-7" style="padding: 0; align-items: center; justify-content: center; flex-wrap: wrap; align-content: center; display: flex; position: relative; height: 4rem;">
        <a href="https://mobiri.se/2892625" style="flex: 1 1; height: 4rem; position: absolute; width: 100%; z-index: 1;">
        ...
        <a style="z-index: 1" href="https://mobirise.com/web-page-maker.html">Free Web Page Maker</a>
    </section>
